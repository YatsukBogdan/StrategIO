...
Game.prototype.move = function(moveString) {
  ...
  switch (validMove.type) {
    ...
    case 'capture' :
      if (this.board[validMove.startSquare][1] === '3' && this.board[validMove.captureSquare][1] === 'b') {
        this.board[validMove.captureSquare] = null;
        this.board[validMove.endSquare] = validMove.pieceCode;
        this.board[validMove.startSquare] = null;
      } else if (this.board[validMove.captureSquare][1] === 'b') {
        this.capturedPieces.push(this.board[validMove.startSquare]);
        this.capturedPieces.push(this.board[validMove.captureSquare]);
        this.board[validMove.startSquare] = null;
        this.board[validMove.captureSquare] = null;
      } else if (this.board[validMove.captureSquare][1] === 'f') {
        this.capturedPieces.push(this.board[validMove.captureSquare]);
        this.board[validMove.captureSquare] = null;
        this.board[validMove.endSquare] = validMove.pieceCode;
        this.board[validMove.startSquare] = null;
        ...
        if (this.board[validMove.captureSquare][0] === 'r') {
          this.looser_color = 'red'
        }
      } else if (this.board[validMove.startSquare][1] === 'y' && this.board[validMove.captureSquare][1] === 't') {
        this.board[validMove.captureSquare] = null;
        this.board[validMove.endSquare] = validMove.pieceCode;
        this.board[validMove.startSquare] = null;
      } else if (this.board[validMove.captureSquare][1] === 's' || this.board[validMove.captureSquare][1] === 'y') {
        this.board[validMove.captureSquare] = null;
        this.board[validMove.endSquare] = validMove.pieceCode;
        this.board[validMove.startSquare] = null;
      } else if (this.board[validMove.startSquare][1] === 's' || this.board[validMove.startSquare][1] === 'y') {
        this.capturedPieces.push(this.board[validMove.startSquare]);
        this.board[validMove.startSquare] = null;
      } else if (this.board[validMove.captureSquare][1] < this.board[validMove.startSquare][1]) {
        this.capturedPieces.push(this.board[validMove.captureSquare]);
        this.board[validMove.captureSquare] = null;
        this.board[validMove.endSquare] = validMove.pieceCode;
        this.board[validMove.startSquare] = null;
    ...
    case 'swap':
      var tmpSquare = this.board[validMove.startSquare];
      this.board[validMove.startSquare] = this.board[validMove.swapSquare];
      this.board[validMove.swapSquare] = tmpSquare;
      break;
