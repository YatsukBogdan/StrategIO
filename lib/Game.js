  ...
  switch (move.type) {
    ...
    case 'spotterCapture':
      if (move.capturePiece === move.guessingPiece) {
        this.board[move.captureSquare] = null;
      } else if (move.capturePiece === 'b') {
        this.board[move.captureSquare] = null;
        this.board[move.startSquare] = null;
      } else if (move.capturePiece === 'f') {
        this.status = 'checkmate';
        this.looser_color = 'blue';
        if (this.board[move.captureSquare][0] === 'r') {
          this.looser_color = 'red'
...
var getMovesForSpotter = function(piece, square, board, status) {
  ...
  if (status === 'strategy') {
    ...
    for (var i=0; i < captureTransforms.length; i++) {
      ...
      if (board[destination]) {
        if (board[destination][0] !== piece[0] && board[destination] !== 'w') {
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '2', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '3', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '4', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '5', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '6', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '7', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '8', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: '9', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: 't', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: 'y', capturePiece: board[destination][1]});
          moves.push({type: 'spotterCapture', pieceCode: piece.substring(0,2), startSquare: square, endSquare: destination, captureSquare: destination, guessingPiece: 's', capturePiece: board[destination][1]});
        }
      }
    }
  }
...
var parseMoveString = function(moveString) {
  ...
  // Captures
    ...
    return {
      ...
      endSquare     : moveString.substring(5, 7),
      captureSquare : moveString.substring(5, 7),
      guessingPiece : moveString.substring(7, 8),
      capturePiece  : moveString.substring(8, 9)
    }
  } else {
    return null;
  }
